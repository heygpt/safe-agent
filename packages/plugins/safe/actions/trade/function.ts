...
import { createPublicClient, erc20Abi, Hex, http, parseUnits } from 'viem';
...
export async function trade(
  ...
  try {
    ...
    return {
      message: `Transaction has been proposed to the Safe for the trade ${args.amountIn} of ${args.tokenIn} for ${routeData.amountOut} of ${args.tokenOut}.`,
      body: {
